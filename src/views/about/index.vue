    ...
    <el-row :gutter="30" class="enter-y">
      <el-col>
        <el-card class="box-card">
          ...
          <div class="descriptions">
            <el-descriptions class="margin-top" direction="horizontal" :column="2" size="default" border>
              <el-descriptions-item label="相关GitHub 仓库">
                <a href="https://github.com/jsxiaosi/tauri-xs-admin" target="_blank">
                  https://github.com/jsxiaosi/tauri-xs-admin
                </a>
              </el-descriptions-item>
              <el-descriptions-item label="本项目GitHub 仓库">
                <a href="https://github.com/jsxiaosi/tauri-xs-admin" target="_blank">
                  https://github.com/jsxiaosi/tauri-xs-admin
                </a>
              </el-descriptions-item>
              <el-descriptions-item label="开发者姓名"> saber_altria </el-descriptions-item>
              <el-descriptions-item label="邮箱"> saberaltria@my.swjtu.edu.cn </el-descriptions-item>
            </el-descriptions>
          </div>
        </el-card>
      </el-col>
